...
{
    public sealed class CharacterSystemEditor : OdinEditorWindow
    {
        #region Constants
        ...
        private const string menuItemName = "HiveMind/Editors/CharacterSystemEditor";
        ...
        {
            CharacterSystemEditor window = GetWindow<CharacterSystemEditor>();
